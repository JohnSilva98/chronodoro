    ...
    <div className=" flex justify-center ">
      ...
      <main className="bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#052e16] w-full h-screen">
       ...
       <form className="flex flex-col items-center justify-center mt-2">
        ...
        <input onChange={(e)=> setTask(e.target.value)} className='text-[var(--text-primary)] border-b-2 border[var(--border-light)] p-2 rounded-sm' type="text" id="task" name="task" value={task} />
